...
/**
 * ─────────────────────────────────────────────────────────────────────────────
 *  XiaoMai LLMs.txt 与 AI 友好内容系统配置指南
 * ─────────────────────────────────────────────────────────────────────────────
 *
 ...
 * - 安全隔离：自动过滤密码保护文章 (encrypted: true) 与draft (draft: true)，绝不泄漏私密内容。
 *
 * ─────────────────────────────────────────────────────────────────────────────
 * 【自动化机制说明（平时写作无需维护本文件）】
 * ─────────────────────────────────────────────────────────────────────────────
...
export const llmsConfig: LlmsConfig = withUserConfig("llms", {
	...
	corePages: [
		...
		},
		{
			title: "About",
			url: "/about/",
			description: "Author profile and project background.",
		},
	],
	 ...
	 *     items: [
	 *       { title: "XiaoMai Theme", url: "https://github.com/GrowWheat/XiaoMai", description: "M3E blog theme for Astro." },
	 *     ],
	 *   },
	 * ]
	 * ```
