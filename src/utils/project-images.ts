 ...
 * co-located covers) lives in `<project>/xiaomais/…`, which no theme-relative
 * glob can ever reach.
 *
 ...
 * no `xiaomais/` directory exists.
 */
const projectImages = import.meta.glob<ImageMetadata>(
	"/xiaomais/**/*.{png,jpg,jpeg,webp,avif,svg,gif}",
	{ import: "default" },
);
 ...
 * in package mode looks like `../xiaomais/content/posts/guide`. Joining it onto
