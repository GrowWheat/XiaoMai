...
if (options.help) {
	console.log(
		[
			...
			"  --out <dir>          Specify export destination directory (default: ../xiaomai-content)",
...
function writeStarterFiles(outAbsolute, plan) {
	...
	writeFileSync(
		...
		[
			"# XiaoMai Content",
			"",
			"这是 XiaoMai 站点的内容仓库，只保存文章、说说、页面数据实体、站点配置和用户图片。",
...
function main() {
	...
	log("  4. In code repository, commit .gitignore, xiaomai.content.json, and index changes");
}
