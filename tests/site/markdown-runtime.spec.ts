...
const PLAIN_POST_PATH = "/posts/提示框/";
const RICH_POST_PATH = "/posts/mdx-集成与原子组件/";
const IMAGE_GRID_POST_PATH = "/posts/image-grid-demo/";
const CODE_POST_PATH = "/posts/代码高亮示例/";
const TREE_POST_PATH = "/posts/markdown-增强功能/";
const COLLAPSE_POST_PATH = "/posts/折叠面板/";
const MARKER_POST_PATH = "/posts/markdown-标记高亮/";
const CONTENT_ANNOTATIONS_POST_PATH = "/posts/内容注释/";
const STEPS_POST_PATH = "/posts/markdown-步骤/";
const ADMONITIONS_POST_PATH = "/posts/提示框/";
const ADMONITION_FREE_POST_PATH = "/posts/代码高亮示例/";
const ABBREVIATIONS_POST_PATH = "/posts/markdown-缩写/";
const OPTION_GROUPS_POST_PATH = "/posts/markdown-选项组/";
const IMAGE_PRESENTATIONS_POST_PATH = "/posts/markdown-扩展功能/";
const IMAGE_PRESENTATIONS_FREE_POST_PATH = "/posts/代码高亮示例/";
const EXPRESSIVE_CODE_FREE_PATH = "/";
const GITHUB_CARD_PATH = "/about/";
const ACFUN_VIDEO_PATH = "/posts/视频嵌入/";
const ARTPLAYER_VIDEO_PATH = "/posts/视频嵌入/";
const AUDIO_READER_POST_PATH = "/posts/语音朗读/";
const BILIBILI_VIDEO_PATH = "/posts/视频嵌入/";
const YOUTUBE_VIDEO_PATH = "/posts/视频嵌入/";
...
test.describe("Markdown syntax runtime loading", () => {
	...
	test("hydrates legacy GitHub cards only after their syntax is rendered", async ({
		...
		await page.route(
			"https://api.github.com/repos/GrowWheat/XiaoMai",
			async (route) => {
		...
		await expect(card).toHaveAttribute(
			"href",
			"https://github.com/GrowWheat/XiaoMai",
		);
	...
	test("keeps the SSR fallback when GitHub API returns an error", async ({
		...
		await page.route("https://api.github.com/repos/GrowWheat/XiaoMai", (route) =>
			route.fulfill({
				status: 503,
				contentType: "application/json",
