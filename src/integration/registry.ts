 ...
 * |---------------------|------------------------------|
 * | `src/config/*`      | `xiaomais/config/*`          |
 * | `src/data/*`        | `xiaomais/config/data/*`     |
 * | `src/components/**` | `src/components/**`          |
 * | `src/layouts/**`    | `src/layouts/**`             |
 */
export function createOverlayTargets(paths: ResolvedXiaoMaisPaths): OverlayTarget[] {
	return [
		{
			label: "config",
 ...
 */
export function buildOverrideRegistry(paths: ResolvedXiaoMaisPaths): OverrideRegistry {
