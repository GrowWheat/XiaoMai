---
name: xiaomai-sidebar
description: "处理 XiaoMai 侧栏系统、widget、FAB 悬浮控件与 Swup 持久壳同步。当新增或配置侧栏 widget、变更侧栏排布或页面过滤、调整 FAB 项或构建路由响应式壳行为时使用。"
---

# XiaoMai 侧栏 / FAB / Swup 持久壳
...
7. **新增 widget**:遵循 `docs/common-components.md` 的新增 checklist,并阅读 `docs/sidebar-widgets.md` 的同类 widget 文档;可选 widget 关闭时遵循零额外负担(见 `xiaomai-feature` 技能)。
