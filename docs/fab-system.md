# 右下角悬浮控制流（FAB）与移动端目录系统规范 — XiaoMai 主题

> 本文档定义 XiaoMai M3E 博客主题的右下角悬浮操作体系（Floating Action Button, FAB）与移动端大纲目录系统（Floating TOC）：
...
XiaoMai 作为偏二次元现代风格的 **M3E（Material 3 Expressive 2025）** 博客主题，右下角悬浮控制流承担着关键的全局交互体验：
...
XiaoMai 对齐 Tailwind CSS 4 响应式标准断点：
