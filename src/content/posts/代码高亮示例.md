...
description: "演示在 Markdown 中使用 Expressive Code 时代码块的外观。"
tags: [Markdown, 博客, 演示]
category: 示例
draft: false
---

这里我们将了解使用 [Expressive Code](https://expressive-code.com/) 时代码块的外观。所提供的示例基于官方文档，如需更多细节可参阅。
...
```ps frame="code" title="PowerShell 配置 Profile.ps1"
