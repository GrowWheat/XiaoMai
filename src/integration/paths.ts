 ...
 */
export const DEFAULT_CONTENT_ROOT = "xiaomais";

/** Cache/scratch directory created inside the user's project. */
export const CACHE_DIR_NAME = ".xiaomais";
 ...
 * from a checkout of the XiaoMai repository. Mirrors Starlight/Stalux detection.
 */
...
export function resolvePaths(
	options: XiaoMaisOptions,
	projectRootUrl: URL,
	moduleUrl: string,
): ResolvedXiaoMaisPaths {
