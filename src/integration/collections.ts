...
/**
 * Content collection definitions for XiaoMai, packaged so a user's
 * `src/content.config.ts` stays three lines long:
 *
 * ```ts
 * import { defineCollections } from "xiaomais/collections";
...
const DEFAULT_CONTENT_DIR = "xiaomais/content";
